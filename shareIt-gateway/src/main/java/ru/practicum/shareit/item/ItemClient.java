...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> findById(long userId, Integer itemId) {
    ...
    public ResponseEntity<Object> update(long userId, ItemRequestUpdateDto itemRequestUpdateDto, long itemId) {
