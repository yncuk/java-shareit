...
public class ItemRequestController {
    ...
    @PostMapping
    public ItemRequestDtoToCreate create(@RequestHeader(HEADER_USER_ID) int requesterId,
    ...
    public ItemRequestDto findById(@RequestHeader(HEADER_USER_ID) int requesterId,
